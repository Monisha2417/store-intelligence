        ...
        for i in range(len(detections)):
            ...
            if tracker_id in previous_positions:
                ...
                if (
                    ...
                    if is_reentry(visitor_id):
                        event_type = "REENTRY"
                        print(f"REENTRY -> {visitor_id}")
                    else:
                        event_type = "ENTRY"
                        print(f"ENTRY -> {visitor_id}")

                    set_active(visitor_id, True)

                    event = create_event(visitor_id, event_type)
                ...
                # -----------------------------
                    ...
                    event = create_event(visitor_id, "EXIT")
                    f.write(json.dumps(event) + "\n")
...
print("DONE")
print(f"Total visitors: {len(visitor_map)}")